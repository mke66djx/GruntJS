...
module.exports = function(vorpal, options) {
    ...
    vorpal
        .command('manPrint<scriptTemplate><dataFile><scriptConfigFile><dataConfigFile>', 'Manual campaign print command. User provides a script template, data file in csv or exel format, and configFile')
